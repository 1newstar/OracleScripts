...
DROP TABLE FCS.INVESTOR_CAT_MV cascade constraints purge;
...
CREATE MATERIALIZED VIEW FCS.INVESTOR_CAT_MV (INVCODE,CATEGORY,DO_NOT_USE)
TABLESPACE UVDATA01
PCTUSED    0
PCTFREE    10
INITRANS   2
...
AS 
/* Formatted on 19/09/2016 11:32:32 (QP5 v5.256.13226.35538) */
SELECT /*+APPEND*/
      invcode,
       /*
       Precedence is
...
COMMENT ON MATERIALIZED VIEW FCS.INVESTOR_CAT_MV IS 'snapshot table for snapshot FCS.INVESTOR_CAT_MV';
...
CREATE MATERIALIZED VIEW FCS.ORDTRAN_MV (ORDUID,INVCODE,TRSTCODE,UNITTYPE,PRODUCT,ISSREP,QUANTITY,AMTDUE,CONSID,PRICE,DEALDT,INDATE,MBDAT,DOD,INITSC,DISCRATE,DISC,DILLEVPC,DILLEVY,COMRATE,COMM,OCOMM,CHARGES,CONVERT2,CONVERT,TRANCODE,SPRACT,SPRACT2,SPRICE,SNARR,SETONDT,AGCODE,MANCODE,CREATEDDATE,CONTRACT_PRINTED,CCY,DECEASED_SELL,FINAL_BONUS,FINAL_BONUS_PEN,WITHDRAWAL_CHG,MVR,REGULAR_BONUS_COST,TERMINAL_BONUS_COST)
TABLESPACE CFA
PCTUSED    0
PCTFREE    10
INITRANS   2
...
ENABLE QUERY REWRITE
AS 
/* Formatted on 19/09/2016 12:27:30 (QP5 v5.256.13226.35538) */
SELECT /*+APPEND*/
      o.orduid,
       o.invcode,
       o.trstcode,
...
COMMENT ON MATERIALIZED VIEW FCS.ORDTRAN_MV IS 'Rationalised/Indexed View of (Primarily) Statement Fields From table ORDTRAN';
