...
WHERE owner NOT IN ('APPQOSSYS', 'DBSNMP', 'CTXSYS', 'OLAPSYS', 'MDSYS', 'DMSYS', 'WKSYS', 'LBACSYS',
                    ...
                    'ORDPLUGINS','OUTLN','ORDDATA','OWBSYS_AUDIT','SCOTT','SI_INFORMTN_SCHEMA')
...
spool T010_SCHEMA_OBJECT_COUNTS_results.lis
/
spool off
...
SELECT owner, object_type, COUNT(*) 
 ...
 SPOOL T010_SCHEMA_OBJECT_COUNTS_JAVA_results.lis
 /
 SPOOL OFF
